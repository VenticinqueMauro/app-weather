...
export const URL_BASE = 'https://api.openweathermap.org/data/2.5/'

export const WEATHER = 'weather?q='

export const FORECAST = 'forecast?q='

export const API_KEY = 'f054734751554df65ed744fb56fcae41'
